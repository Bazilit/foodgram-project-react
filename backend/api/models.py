...
class Tag(models.Model):
    ...
    name = models.CharField(verbose_name='Название тэга', max_length=200,)
    color = models.CharField(verbose_name='Цвет тэга', help_text='Цвет в формате HEX. Пример: #E26C2D', max_length=7, unique=True,)
...
class IngredientInRecipe(models.Model):
    ...
    amount = models.DecimalField(max_digits=10, decimal_places=1, verbose_name='Кол-во', validators=[MinValueValidator(Decimal('0.1'))],)
...
class ShoppingCart(models.Model):
    ...
    recipe = models.ForeignKey(Recipe, on_delete=models.CASCADE, related_name="shopping_carts", verbose_name='Рецепт',)
